...
const CACHE = 'markus-a-v6';
const CORE = ['./', './index.html', './config.js', './manifest.json', './css/app.css',
  './js/core.js', './js/native.js', './js/i18n-dict.js', './js/i18n.js', './js/logic.js', './js/ai.js', './js/cloud.js', './js/ui.js', './js/screens.js', './js/extras.js', './js/places.js', './js/help.js', './js/assist.js', './js/voice.js', './js/main.js',
